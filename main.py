...
# This part is image labels setting start 
        ...
        # Photo   button 6
        pho_img_btn=Image.open(r"Images_GUI\reg1.png")
        ...
        pho_b1_1 = Button(bg_img,command=self.open_img,text="Images",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
