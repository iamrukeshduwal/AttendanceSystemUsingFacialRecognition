...
class Student:
    ...
    # This part is image labels setting start 
        ...
        droplist = OptionMenu(class_Student_frame, self.var_emailaddress, *list1)
        droplist.config(width = 15)
        self.var_emailaddress.set('@hotmail.com')
        droplist.grid(row=5,column=3,padx=5,pady=5,sticky=W)
...
# ==================Function Decleration==============================
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_course.get=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_id.get()=="" or self.var_std_name.get()=="" or self.var_div.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_mob.get()=="" or self.var_address.get()=="" or self.var_teacher.get()=="":
            ...
            messagebox.showerror("Error","Please provide valid mobile number",parent=self.root)
            ...
            try:
                ...
                if row!=None:
                    ...
                    self.var_fullemail = StringVar()
                    self.var_fullemail.set(self.var_email.get() + self.var_emailaddress.get())            
    ...
    def get_cursor(self,event=""):
        ...
        self.var_photoid.set(self.var_std_id.get())
        # print(self.var_photoid.get())
    # ========================================Update Function==========================
        ...
        if self.var_dep.get()=="Select Department" or self.var_course.get=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_id.get()=="" or self.var_std_name.get()=="" or self.var_div.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_mob.get()=="" or self.var_address.get()=="" or self.var_teacher.get()=="":
            ...
            try:
                ...
                if Update > 0:
                    ...
                    self.var_fullemail = StringVar()
                    self.var_fullemail.set(self.var_email.get() + self.var_emailaddress.get()) 
                    mycursor.execute("update student set Name=%s,Department=%s,Course=%s,Year=%s,Semester=%s,Division=%s,Gender=%s,DOB=%s,Mobile_No=%s,Address=%s,Roll_No=%s,Email=%s,Teacher_Name=%s,PhotoSample=%s,Student_ID=%s where Student_ID=%s",( 
                    self.var_std_name.get(),
                    self.var_dep.get(),
                    self.var_course.get(),
                    self.var_year.get(),
            ...
            try:
                ...
                while True:
                    ...
                    if face_croped(my_frame) is not None:
                        ...
                        file_path="data_img/stdudent."+str(self.var_photoid.get())+"."+str(img_id)+".jpg"
